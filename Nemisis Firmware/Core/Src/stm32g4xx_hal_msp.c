...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA3     ------> ADC1_IN4
    */
    GPIO_InitStruct.Pin = RIGHT_FRONT_RECEIVER_Pin|LEFT_FRONT_RECEIVER_Pin|LEFT_M_RECEIVER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = LEFT_LM_RECEIVER_Pin|RIGHT_M_RECEIVER_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  */
    ...
    PB15     ------> ADC4_IN5
    */
    GPIO_InitStruct.Pin = M2_CURRENT_SENSE_Pin|M1_CURRENT_SENSE_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  if(hadc->Instance==ADC1)
  {
    ...
    PA3     ------> ADC1_IN4
    */
    HAL_GPIO_DeInit(GPIOC, RIGHT_FRONT_RECEIVER_Pin|LEFT_FRONT_RECEIVER_Pin|LEFT_M_RECEIVER_Pin);

    HAL_GPIO_DeInit(GPIOA, LEFT_LM_RECEIVER_Pin|RIGHT_M_RECEIVER_Pin);
  ...
  else if(hadc->Instance==ADC4)
  {
    ...
    PB15     ------> ADC4_IN5
    */
    HAL_GPIO_DeInit(GPIOB, M2_CURRENT_SENSE_Pin|M1_CURRENT_SENSE_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    PA8     ------> I2C3_SCL
    */
    GPIO_InitStruct.Pin = FUEL_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_I2C3;
    HAL_GPIO_Init(FUEL_SDA_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = FUEL_SCL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_I2C3;
    HAL_GPIO_Init(FUEL_SCL_GPIO_Port, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  if(hi2c->Instance==I2C3)
  {
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(FUEL_SDA_GPIO_Port, FUEL_SDA_Pin);

    HAL_GPIO_DeInit(FUEL_SCL_GPIO_Port, FUEL_SCL_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  else if(hspi->Instance==SPI3)
  {
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(GPIOC, ENCODER_SCK_Pin|ENCODER_MISO_Pin|ENCODER_MOSI_Pin);
...
void HAL_TIM_Encoder_MspInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  if(htim_encoder->Instance==TIM1)
  {
    ...
    PA9     ------> TIM1_CH2
    */
    GPIO_InitStruct.Pin = ENCODERL_A_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM1;
    HAL_GPIO_Init(ENCODERL_A_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ENCODERL_B_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF6_TIM1;
    HAL_GPIO_Init(ENCODERL_B_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM3)
  {
    ...
    PB7     ------> TIM3_CH4
    */
    GPIO_InitStruct.Pin = M2_IN1_Pin|M1_IN2_Pin|M1_IN1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  else if(htim->Instance==TIM8)
  {
    ...
    PB9     ------> TIM8_CH3
    */
    GPIO_InitStruct.Pin = VACCUM_FAN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF10_TIM8;
    HAL_GPIO_Init(VACCUM_FAN_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  if(htim_encoder->Instance==TIM1)
  {
    ...
    PA9     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(ENCODERL_A_GPIO_Port, ENCODERL_A_Pin);

    HAL_GPIO_DeInit(ENCODERL_B_GPIO_Port, ENCODERL_B_Pin);
  ...
  else if(htim_encoder->Instance==TIM2)
  {
    ...
    PA5     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(GPIOA, ENCODERR_A_Pin|ENCODERR_B_Pin);
